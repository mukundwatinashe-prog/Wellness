...
**Project:** Wellness Social Care Services
**Generated:** 2026-06-19 16:14:21
...
|------|-----|--------------|
| Primary | `#0041CC` | `--blue` |
| Secondary | `#2563EB` | `--blue-light` |
| CTA/Accent | `#F7941D` | `--orange` |
| Background | `#EFF6FF` | `--blue-bg` |
| Text | `#0F172A` | `--gray-900` |

**Color Notes:** Brand blue and orange palette — preserved across redesign
